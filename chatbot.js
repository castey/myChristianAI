    ...
    tools = [
        {
            ...
            "function": {
                "name": "generateImage",
                "description": `Generates an AI image upon direct unambiguous user request for image. Do not generate an image unless the user specifically asks for one. It is very important that you only create images if the user specifically and directly asks for one`,
                "parameters": {
                    "type": "object",
                    "properties": {
                        "prompt": {
